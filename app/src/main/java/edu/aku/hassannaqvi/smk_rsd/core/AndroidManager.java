...
public class AndroidManager extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
        dbm = new DatabaseHelper(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);

        mainscrollview = new ScrollView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        mainLayout = new LinearLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        final LinearLayout firstrow = new LinearLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        firstrow.setPadding(0, 10, 0, 20);
        LinearLayout.LayoutParams firstrowlp = new LinearLayout.LayoutParams(0, 150);
        firstrowlp.weight = 1;

        TextView maintext = new TextView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        maintext.setText("Select Table");
        maintext.setTextSize(22);
        maintext.setLayoutParams(firstrowlp);
        select_table = new Spinner(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        hsv = new HorizontalScrollView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);

        //the main table layout where the content of the sql tables will be displayed when user selects a table
        tableLayout = new TableLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        tableLayout.setHorizontalScrollBarEnabled(true);
        hsv.addView(tableLayout);

        //the second row of the layout which shows number of records in the table selected by user
        final LinearLayout secondrow = new LinearLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        TextView secondrowtext = new TextView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        secondrowtext.setText("No. Of Records : ");
        secondrowtext.setTextSize(20);
        secondrowtext.setLayoutParams(secondrowlp);
        tv = new TextView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        tv.setTextSize(20);
        ...
        final Button submitQuery = new Button(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        final TextView help = new TextView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        final Spinner spinnertable = new Spinner(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        previous = new Button(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        next.setText("Next");
        ...
        tvmessage = new TextView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        final Button customQuery = new Button(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this,
                    ...
                    if (c2 != null) {
                        ...
                        spinnertable.setOnItemSelectedListener((new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this)
                                ...
                                if (spinnertable.getSelectedItem().toString().equals("Add row to this table")) {
                                    ...
                                    final ScrollView addrowsv = new ScrollView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
                                    ...
                                    for (int i = 0; i < addnewrownames.size(); i++) {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
                        ...
                        for (int k = 0; k < c2.getColumnCount(); k++) {
                            LinearLayout cell = new LinearLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
    ...
    public void updateDeletePopup(int row) {
        ...
        final RelativeLayout lp = new RelativeLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv = new ScrollView(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        LinearLayout lcrud = new LinearLayout(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(edu.aku.hassannaqvi.smk_rsd.core.AndroidManager.this,
